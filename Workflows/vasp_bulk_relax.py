...
# resolve the working directory and render POSCAR / INCAR / POTCAR / KPOINTS
# content as strings (nothing is written to disk yet)
...
# write the rendered files to disk and run VASP
