...
from pyiron_nodes.atomistic.engine.lammps import CreateLammpsStaticInput, CreateLammpsStructure, ListPotentials, ParseLammpsStaticOutput, RunLammpsCalculation
...
wf.CreateLammpsStructure = CreateLammpsStructure(structure=wf.Repeat, potential=wf.pick_element, working_directory='./lammps_static')

wf.CreateLammpsStaticInput = CreateLammpsStaticInput(io_bundle=wf.CreateLammpsStructure)

wf.RunLammpsCalculation = RunLammpsCalculation(io_bundle=wf.CreateLammpsStaticInput, debug=False)

wf.ParseLammpsStaticOutput = ParseLammpsStaticOutput(io_bundle=wf.RunLammpsCalculation.outputs.io_bundle)
