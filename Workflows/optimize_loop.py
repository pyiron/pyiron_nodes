...
from pyiron_nodes.dpg2026.atomistic.calculator.optimize import GenericOptimizerSettings, MapCalculatorOnStructures, Relax
...
wf.iterate.inputs.add("debug", port_type=bool, default=False, value=False, has_explicit_default=True)
wf.iterate.inputs.add("executor", port_type=object, default=None, value=None, has_explicit_default=True)

wf.MapCalculatorOnStructures = MapCalculatorOnStructures(structures=wf.iterate, calculator=wf.Relax)
wf.MapCalculatorOnStructures.inputs.add("store", port_type=bool, default=False, value=False, has_explicit_default=True)
