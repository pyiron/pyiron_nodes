...
Q_pos = {Q_pos}
Q0 = (
    0  # Initial charge, when restarting change this to charge of second last ionic step
)
rQ_list = [Q_pos]
Q_list = [Q0]
...
def local_potential(constants, additions):
    ...
    if check_normalization(nelect_neutral, total_nelect):
        ...
        dipole, new_chargedensity = calc_dipole(
            total_charge / Lx / Ly / Lz, Lz, nz, core_dipole / Lx / Ly
        )
        total_pot = electrostatic_potential(
            new_chargedensity, Lx, Ly, Lz, epsilon_0=0.005526349358057108
        )
